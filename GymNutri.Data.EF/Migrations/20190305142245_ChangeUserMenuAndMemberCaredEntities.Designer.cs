...
namespace GymNutri.Data.EF.Migrations
{
    ...
    [Migration("20190305142245_ChangeUserMenuAndMemberCaredEntities")]
    partial class ChangeUserMenuAndMemberCaredEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.BodyClassification", b =>
                {
                    ...
                    b.Property<string>("ListTemplateMenuIds")
                        .HasMaxLength(500);
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.Food", b =>
                {
                    ...
                    b.Property<decimal>("CarbPerUnit")
                    ...
                    b.Property<decimal>("KcalPerUnit")
                        .HasColumnType("decimal(18,5)");
                    ...
                    b.Property<decimal>("SaturatedFatPerUnit")
                        .HasColumnType("decimal(18,5)");
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.SetOfFood", b =>
                {
                    ...
                    b.Property<string>("ListFoodNames")
                        .HasMaxLength(500);

                    b.Property<string>("ListMealIds")
                        .HasMaxLength(500);

                    b.Property<string>("ListMealNames")
                        .HasMaxLength(500);
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenu", b =>
                {
                    ...
                    b.Property<string>("BodyClassifications")
                        .HasMaxLength(500);

                    b.Property<decimal>("CarbAverage")
                        .HasColumnType("decimal(18,5)");
                    ...
                    b.Property<decimal>("FatAverage")
                        .HasColumnType("decimal(18,5)");

                    b.Property<decimal>("KcalAverage")
                        .HasColumnType("decimal(18,5)");
                    ...
                    b.Property<decimal>("ProteinAverage")
                        .HasColumnType("decimal(18,5)");

                    b.Property<decimal>("SaturatedFatAverage")
                        .HasColumnType("decimal(18,5)");
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenuForBodyClassification", b =>
                {
                    ...
                    b.Property<string>("InsertedSource")
                        .HasMaxLength(255);
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenuSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TemplateMenuSets");
                });

            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenuSetDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("TemplateMenuSetId");
                    ...
                    b.HasIndex("TemplateMenuSetId");

                    b.ToTable("TemplateMenuSetDetails");
                });
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.UserBodyIndex", b =>
                {
                    ...
                    b.Property<decimal>("AssCm");

                    b.Property<decimal>("BellyCm");

                    b.Property<decimal>("BellyIn");
                    ...
                    b.Property<decimal>("HeightFt");

                    b.Property<decimal>("HeightIn");

                    b.Property<decimal>("HeightM");

                    b.Property<decimal>("IdiWproBmi");
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.UserDesire", b =>
                {
                    ...
                    b.Property<string>("ChangingSpeed")
                        .HasMaxLength(255);
                    ...
                    b.Property<string>("PracticeIntensive")
                        .HasMaxLength(255);
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenuForBodyClassification", b =>
                {
                    b.HasOne("GymNutri.Data.Entities.BodyClassification", "BodyClassification")
                        .WithMany("TemplateMenuForBodyClassifications")
            ...
            modelBuilder.Entity("GymNutri.Data.Entities.TemplateMenuSetDetail", b =>
                {
                    ...
                    b.HasOne("GymNutri.Data.Entities.TemplateMenuSet", "TemplateMenuSet")
                        .WithMany("TemplateMenuSetDetails")
                        .HasForeignKey("TemplateMenuSetId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
